...
/* 4 */
/*!***************************************************************************!*\
  !*** /Users/yundongjiutian/Desktop/git-examples/sqkbFe/sqkbFe/pages.json ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!********************************************************************************************!*\
  !*** /Users/yundongjiutian/Desktop/git-examples/sqkbFe/sqkbFe/pages.json?{"type":"style"} ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/home/home": { "navigationBarTitleText": "省钱快报", "enablePullDownRefresh": true, "navigationBarBackgroundColor": "#FF512E", "usingComponents": { "sq-single-coupon": "/components/sq-single-coupon/sq-single-coupon" }, "usingAutoImportComponents": {} }, "pages/detail/detail": { "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarTitleText": "", "navigationBarBackgroundColor": "#000000", "backgroundColor": "#ffffff" } };exports.default = _default;

/***/ }),
/* 8 */
/*!*******************************************************************************************!*\
  !*** /Users/yundongjiutian/Desktop/git-examples/sqkbFe/sqkbFe/pages.json?{"type":"stat"} ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__167D078" };exports.default = _default;
...
var requestSqkb = function requestSqkb(_ref)




{var _ref$url = _ref.url,url = _ref$url === void 0 ? '' : _ref$url,_ref$data = _ref.data,data = _ref$data === void 0 ? {} : _ref$data,_ref$method = _ref.method,method = _ref$method === void 0 ? 'GET' : _ref$method,_ref$header = _ref.header,header = _ref$header === void 0 ? {} : _ref$header,_ref$loading = _ref.loading,loading = _ref$loading === void 0 ? false : _ref$loading;
  if (method == 'POST') {
    header['content-type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
  }
  if (!url) {
    var error = new Error('缺少参数');
    return Promise.reject(error);
  }
  if (loading) {
    uni.showLoading();
  }
  var params = addCommonParams(data);
  var appSecret = appSecrets[params.client_id];
  return uni.request({
    url: url,
    data: data,
    header: header }).
...
//增加公共参数
exports.requestSqkb = requestSqkb;var addCommonParams = function addCommonParams(data) {
  var isIos = uni.getSystemInfoSync().platform == 'ios' ? true : false;
  var client_id = isIos ? 20 : 21;
...
//生成签名
var setSign = function setSign(qs, app_secret) {
  var qsArr = [];
  for (var p in qs) {
  ...
  qsArr.sort();
  qsArr = qsArr.join('&');
  var signStr = qsArr + app_secret;
  var sign = (0, _md.default)(signStr);
  return sign;
};
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var apiBaseUrls = {
...
Object.keys(apis).forEach(function (key) {
  apis[key] = "".concat(apiBaseUrl).concat(apis[key]);
});var _default =
